...
public class DotNetMethod
{
    ...
    public readonly Method BackendTabel;
    ...
    private byte[] ReadMethodBody()
    {
        ...
        for (var i = Offset + 1; i < Offset + 1 + CodeSize; i++)
        {
            var opcode = fs.ReadByte();
    ...
    {
        var ret = new MethodSignatureInfoV2();
        var sig = "";
    ...
    internal static MethodSignatureParam ReadParam(BinaryReader r, DotNetFile file)
    {
        string sig;
        var parm = r.ReadByte();
        var ret = new MethodSignatureParam();
        switch (parm)
        {
            case 0x00:
            {
                ...
                //valve type (followed by typedef or typeref token)
            {
                ...
                IlDecompiler.DecodeTypeDefOrRef(t, out var rowType, out var index);
                string name;
                string Namespace;
            ...
            case 0x15:
            {
                ...
                IlDecompiler.DecodeTypeDefOrRef((uint)c, out var rowType, out var index);
                ret.IsGeneric = true;
                ret.type = StackItemType.Object;
                var @params = new List<MethodSignatureParam>();
                for (ulong i = 0; i < d; i++)
                {
            ...
            case 0x1F:
                ...
                IlDecompiler.DecodeTypeDefOrRef((uint)num3, out var rowType3, out var index3);
                sig = "TODO: 0x1F";
                break;
            case 0x20:
                var num2 = IlDecompiler.ParseNumber(r);
                IlDecompiler.DecodeTypeDefOrRef((uint)num2, out var rowType2, out var index2);
                sig = "TODO: 0x20";
                break;
            default:
    ...
    public class MethodSignatureInfoV2
    {
        ...
        public readonly List<MethodSignatureParam> Params = new List<MethodSignatureParam>();
